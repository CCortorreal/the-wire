...
import { endpoint, observePrompt, pull, list, context, leaseAcquire, leaseResolve, leaseRenewEndpoint } from './wire-store.mjs';
...
try {
  ...
  if (!delta.length && !actionable.length) { console.log('{}'); process.exit(0); }
